describe('Login', () => {
  ...
  //   cy.get("div.MuiCollapse-root > div > div > div > div > div:nth-of-type(1) > div.flex > div.flex-1 input").click();
  //   cy.get("div.MuiCollapse-root > div > div > div > div > div:nth-of-type(1) > div.flex > div.flex-1 input").type("vicky");
  //   cy.get("div:nth-of-type(2) > div.MuiCollapse-root > div > div > div > div > div:nth-of-type(1) > div:nth-of-type(2) input").click();
  //   cy.get("div:nth-of-type(2) > div.MuiCollapse-root > div > div > div > div > div:nth-of-type(1) > div:nth-of-type(2) input").type("sm");
  //   cy.get("form > div > div:nth-of-type(2) div > div > div:nth-of-type(2) > div:nth-of-type(2) input").click();
  //   cy.get("form > div > div:nth-of-type(2) div > div > div:nth-of-type(2) > div:nth-of-type(2) input").type("vicky@gmail.com");
